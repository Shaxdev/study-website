...
from models1.models import MainModel
...
class TestModul(models.Model):
    ...
    moduls_test_key = models.ForeignKey(MainModel, models.CASCADE, verbose_name='Test Moduli')
    ...
    time_time = models.DateTimeField(auto_now_add=True)
